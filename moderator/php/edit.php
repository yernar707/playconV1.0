  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/play/moderator/index.php"><span class="glyphicon glyphicon-user"></span> Account</a></li>
...
<div class="wrap">
  ...
  <div class="internal" id="account">
    <form class="action_form" action="/play/moderator/php/savedetails.php" method="post">
