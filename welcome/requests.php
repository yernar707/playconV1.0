...
<head>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      $('#requests').load('/play/welcome/php/requests.php');
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <form action="/play/welcome/php/createown.php" method="post" novalidate>
      <div class="item_field">
        <select name="type" id="selectsport" onchange="select();">
          <option disabled="" selected="" value="2">Choose sport type</option>
          <option value="Football">Football</option>
          <option value="Basketball">Basketball</option>
          <option value="Tennis">Tennis</option>
          <option value="DoTA">DoTA</option>
          <option value="CS:GO">CS:GO</option>
          <option id="another" value="another">another</option>
        </select>
      </div>
      <div class="item_field" id="sport" style="display: none;" >
        <input  type="text" id="anothersport" name="empty" placeholder="Sport type" required="">
      </div>
      <div class="item_field">
      ...
      <div class="item_field">
        <input type="number" name="max" placeholder="maximum people needed" required="">
      </div>
      <div class="item_field">
